...
class Test_generateRequest(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.sender: tMsgSender = tMsgSender(self.tToken)
    
    # A test for generating a URL from 1 msgParam
    def test_getMe(self) -> None:
        self.assertEqual(self.sender.generateRequest(["getMe"]), f"https://api.telegram.org/bot{self.tToken}/getMe")
    ...
    def test_getUpdates(self) -> None:
        ...
        self.assertEqual(self.sender.generateRequest(request), correctURL)
